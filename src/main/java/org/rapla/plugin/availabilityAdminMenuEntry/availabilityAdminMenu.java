...
@Extension(provides = AdminMenuExtension.class,id=availabilityAdminMenu.PLUGIN_ID)
public class availabilityAdminMenu  extends RaplaGUIComponent implements AdminMenuExtension, ActionListener
{
	public static final String PLUGIN_ID ="org.rapla.plugin.availabilityAdminMenuEntry";
    ...
    private final availabilityAdminMenuResources editMenuI18n;
    private final Provider<availabilityAdminMenuDialog> copyDialogProvider;
    private final DialogUiFactoryInterface dialogUiFactory;
	@Inject
    public availabilityAdminMenu(ClientFacade facade, RaplaResources i18n, RaplaLocale raplaLocale, Logger logger, availabilityAdminMenuResources editMenuI18n, Provider<availabilityAdminMenuDialog> copyDialogProvider,  DialogUiFactoryInterface dialogUiFactory)  {
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        final availabilityAdminMenuDialog useCase = copyDialogProvider.get();
