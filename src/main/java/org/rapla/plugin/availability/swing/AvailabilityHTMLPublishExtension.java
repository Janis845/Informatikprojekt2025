...
public class AvailabilityHTMLPublishExtension extends RaplaGUIComponent implements PublishExtension
{
	 ...
	 AvailabilityResources availabilityI18n;
	 RaplaResources i18n;
     private final IOInterface ioInterface;
	JComboBox pagesBox;

	 public AvailabilityHTMLPublishExtension(ClientFacade facade, RaplaResources i18n, RaplaLocale raplaLocale, Logger logger,CalendarSelectionModel model, AvailabilityResources availabilityI18n, IOInterface ioInterface)
	 {
		...
		htmlURL = new JTextField();
		 ...
		 checkbox = new JCheckBox("Verfügbarkeiten abfragen");// checkbox = new JCheckBox("HTML " + i18n.getString("publish"));
        ...
        panel.add(new JLabel(availabilityI18n.getString("show_navigation")),"2,4");
        ...
        panel.add(new JLabel(availabilityI18n.getString("only_allocation_info")),"2,10");
        panel.add( onlyAllocationInfoField, "4,10");
        panel.add(new JLabel(availabilityI18n.getString("resources_as_linklist")),"2,12");
        panel.add( asLinkListField, "4,12");
		panel.add( statusHtml, "2,14,4,1");
        {	
            final String entry = model.getOption(AvailabilityPlugin.HTML_EXPORT);
	...
	public void mapOptionTo() 
	{
		...
		model.setOption( AvailabilityPlugin.HTML_EXPORT, htmlSelected);
	}
	...
	public void setAdress(String generator, String address) {
		if ( AvailabilityPlugin.CALENDAR_GENERATOR.equals( generator)) {
	...
	{
		return new String[] {AvailabilityPlugin.CALENDAR_GENERATOR};
	}
