...
@Singleton
@Extension(provides = I18nBundle.class, id = AvailabiltyPlugin.PLUGIN_ID)
public class AvailabilityResources extends AbstractBundle
{
    private static final String BUNDLENAME = AvailabiltyPlugin.PLUGIN_ID +  ".AvailabilityResources";
        @Inject
