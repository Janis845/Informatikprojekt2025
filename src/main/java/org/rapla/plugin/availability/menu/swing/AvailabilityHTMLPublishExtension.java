...
public class AvailabilityHTMLPublishExtension extends RaplaGUIComponent implements PublishExtension
{
	...
	JComboBox pagesBox;
	 ...
	 public AvailabilityHTMLPublishExtension(ClientFacade facade, RaplaResources i18n, RaplaLocale raplaLocale, Logger logger,CalendarSelectionModel model, AvailabilityResources availabilityI18n, IOInterface ioInterface)
	 {
        ...
        {	
            final String entry = model.getOption(AvailabiltyPlugin.HTML_EXPORT);
	...
	public void mapOptionTo() 
	{
		...
		model.setOption( AvailabiltyPlugin.HTML_EXPORT, htmlSelected);
	}
	...
	public void setAdress(String generator, String address) {
		if ( AvailabiltyPlugin.CALENDAR_GENERATOR.equals( generator)) {
	...
	{
		return new String[] {AvailabiltyPlugin.CALENDAR_GENERATOR};
	}
