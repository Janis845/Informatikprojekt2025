...
@Extension(provides = PluginOptionPanel.class, id = AvailabiltyPlugin.PLUGIN_ID)
public class AvailabilityPluginOption implements PluginOptionPanel
{
    ...
    {
        preferences.putEntry(AvailabiltyPlugin.SHOW_CALENDAR_LIST_IN_HTML_MENU, test1.isSelected());
        preferences.putEntry(AvailabiltyPlugin.SHOW_TOOLTIP_IN_EXPORT_CONFIG_ENTRY, test2.isSelected());
    }

    @Override
    public void show() throws RaplaException
    {
        test1.setSelected(preferences.getEntryAsBoolean(AvailabiltyPlugin.SHOW_CALENDAR_LIST_IN_HTML_MENU, true));
        test2.setSelected(preferences.getEntryAsBoolean(AvailabiltyPlugin.SHOW_TOOLTIP_IN_EXPORT_CONFIG_ENTRY, true));
