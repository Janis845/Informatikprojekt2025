...
import org.rapla.client.menu.AllocatableReservationMenuContext;
...
public class AllocatableSelection extends RaplaGUIComponent implements AppointmentListener, PopupListener, RaplaWidget
{
    ...
    Collection<Appointment> selectedAppointments = Collections.emptyList();
    ...
    private void updateButtons()
    {
        ...
        }
        {
            ...
            calendarAction1.setEnabled(enable && !template);
        ...
        }
        {
            ...
            calendarAction2.setEnabled(enable && !template);
    ...
    public void showPopup(PopupEvent evt)
    {
        try
        {
            ...
            SelectionMenuContext menuContext = new SelectionMenuContext( selectedObject, popupContext);
            ...
            if ( menuFactory != null)
            {
                menuFactory.addNewMenu(newMenu, menuContext, null);
    ...
    protected SelectionMenuContext createMenuContext(Point p, Object obj, JComponent table)
    {
        final SwingPopupContext popupContext = new SwingPopupContext(getComponent(), p);
        SelectionMenuContext menuContext = new SelectionMenuContext( obj, popupContext);
        return menuContext;
    }
    ...
    class AllocatableAction extends AbstractAction
    {
        ...
        AllocatableAction(String command, TreeFactory treeFactory)
        {
            ...
            if (command.equals("add"))
            {
                ...
                setIcon(i18n.getIcon("icon.arrow_right"));

            }
            if (command.equals("remove"))
            {
                putValue(NAME, getString("remove"));
                setIcon(i18n.getIcon("icon.arrow_left"));
            }
        ...
        public void actionPerformed(ActionEvent evt)
        {
            ...
            if (command.contains("calendar"))
            {
                ...
                AllocatableReservationMenuContext menuContext = new AllocatableReservationMenuContext(null,dialogUiFactory.createPopupContext(AllocatableSelection.this));
                final Collection<Allocatable> selectedAllocatables = getSelectedAllocatables(tree.getTree());
                ...
                menuContext.setStart( firstStart);
                menuFactory.executeCalenderAction(menuContext);
            }
        }
